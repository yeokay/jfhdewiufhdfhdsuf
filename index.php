                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-body text-center anime">
                                ...
                                <textarea rows="1" class="form-control text-center"
                                    style="width: 30%; float: left; margin-bottom: 5px; resize:none; overflow:hidden;"
                                    id="cust" placeholder="CURRENCY"></textarea>--></br>
    ...
    <option
            ...
            <footer>
                <p> <b>
						...
						<br>
						<a href="https://t.me/undefychatchk" style="font-family: Teko, Bangla537, sans-serif;">𝐉𝐎𝐈𝐍 𝐎𝐔𝐑 𝐂𝐎𝐌𝐌𝐔𝐍𝐈𝐓𝐘
                    </b></a>
        </div>
        </p>
        </footer>
            ...
            $('.btn-play').click(function() {
                ...
                */
                ...
                line.forEach(function(data) {
                    var callBack = $.ajax({
                        url: gate + '?lista=' + data + '&tgm=' + tgm+ '&sec=' + sec + '&cst=' + cst,
